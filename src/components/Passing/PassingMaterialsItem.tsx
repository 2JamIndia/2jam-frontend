...
const PassingMaterialsItem: React.FC<PassingMaterialsItemProps> = ({
	...
	return (
		<div className="passing-info-materials-item-wrapper">
			<div
				onClick={() => downloadFile(title, index + 1)}
				className="passing-info-materials-item"
			>
				<div className="passing-info-materials-item-icon">
					<svg
						width="20"
						height="20"
						viewBox="0 0 20 20"
				...
				<p className="passing-info-materials-item__title">
					{title}
				</p>

				{isDownloading ? <span className="passing-info-materials-item__loader"></span> : null}
			</div>
		</div>
	);
};
